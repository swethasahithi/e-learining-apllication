    ...
    <div class="container-fluid">
 	...
 	<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter the unique Government ID*" name="uid">
                </div>

	<div class="form-group">
                  <!--<label for="Dept" class="text-uppercase" >Department</label>-->
                  <input type="text" class="form-control" placeholder="Enter the department*" name="dept">
                </div>
                <div class="form-group">
