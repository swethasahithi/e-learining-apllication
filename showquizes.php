  ...
  <!-- Navigation-->
      ...
      <div class="content-wrapper">
          ...
          <div class="container-fluid">
              ...
              <!-- <?php $temp=$conn->query("select * from ")?>   -->
              <?php $result=getUlbQuizList($topic_id,$sub_topic_id);?>      
                      ...
                      <form>
                        ...
                        <input type="hidden" name="quiz_id" value="<?php echo $row['quiz_id'];?>"/>
                          <tr>
                            ...
                            <td class="text-right">
                              <div class="btn-group">
                              <button type="submit" formaction="ulbquiz.php" class="btn btn-primary">View</button>
                            </div>
                          </td>
                          </tr>
                      </form>
